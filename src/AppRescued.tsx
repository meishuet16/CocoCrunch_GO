...
export default function AppRescued() {
  ...
  function confirmCourt() {
    ...
    const losingBackups = promoteCourtLosers(courtOptions.map(option => ({ ...option, support: tally.counts[option.id] ?? 0 })), winnerId, profile.veto);
