...
export function MemoryArchiveGuide({ onOpenTrip }: PhaseGuideButtonProps) {
  return <section className="memory-loop-card" aria-label="Retrospective doorway">
    <div><span>REVIEW TRIP</span><h3>Review first, then keep the memory.</h3><p>Open the completed trip to review actual outcome → Worth It/reflection → proposed learning. Long-term Tingo changes only after explicit confirmation.</p></div>
